...
#define CURVE_NUM           4       //Number of curves to plot
#define ID_MAX              20    //Max allowable current. Enter 100-fold the desired current in mA
#define ID_TH               1      //Current to define on state at 1 V Vds. Enter 100-fold the desired current in mA
