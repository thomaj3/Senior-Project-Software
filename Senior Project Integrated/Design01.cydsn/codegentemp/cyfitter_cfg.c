...
#define BS_UDB_1_4_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000414u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x4800051Cu)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000524u)
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_3__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_3__maskTable[4] = {
	0x08u, 0x80u, 
	0x08u, 0x00u, 
};

/*******************************************************************************
* Function Name: AMux_3_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void AMux_3_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_3__addrTable[channel] |= AMux_3__maskTable[channel];
		channel++;
		*AMux_3__addrTable[channel] |= AMux_3__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void AMux_3_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_3__addrTable[channel] &= (uint8)~AMux_3__maskTable[channel];
		channel++;
		*AMux_3__addrTable[channel] &= (uint8)~AMux_3__maskTable[channel];
	}
}
